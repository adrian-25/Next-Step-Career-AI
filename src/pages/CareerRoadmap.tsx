              ...
              <Card className="glass-card neon-glow">
                <CardHeader>
                  <CardTitle className="flex items-center space-x-2">
                    ...
                    <span className="neon-text">Generate Your Roadmap</span>
                  </CardTitle>
                ...
                <CardContent className="space-y-4">
                  <Input
                    ...
                    className="text-lg glass border-primary/30 focus:border-primary"
                  />
                  <Button 
                    onClick={generateRoadmap} 
                    disabled={isGenerating}
                    className="w-full gradient-bg neon-glow text-black font-bold"
                    size="lg"
                  >
